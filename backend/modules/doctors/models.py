...
class Doctor(Base):
    ...
    queue_prefix = Column(String(1), default='A', nullable=False)  # A, B, C for queue numbering
...
class DoctorService(Base):
    ...
    priority = Column(Integer, default=0) # Higher number = higher priority (default selection)
