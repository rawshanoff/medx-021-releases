...
def upgrade() -> None:
    ...
    op.add_column('patients', sa.Column('telegram_chat_id', sa.BigInteger(), nullable=True))
    op.add_column('patients', sa.Column('telegram_username', sa.String(), nullable=True))
