...
import { getPrintSettings, loadReceiptForTicket, printQueueTicket, printReceipt } from '../../utils/print';
                ...
                <Button
                    ...
                    onClick={() => {
                        ...
                        if (cached) {
                            ...
                            printQueueTicket(
                                { ticket_number: first.ticket_number, patient_name: first.patient_name, doctor_name: first.doctor_name, created_at: first.created_at },
                                settings
                            );
                        }
                    }}
                        ...
                        <div className="flex items-start justify-between gap-2">
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    ...
                                    printQueueTicket(
                                        { ticket_number: item.ticket_number, patient_name: item.patient_name, doctor_name: item.doctor_name, created_at: item.created_at },
                                        settings
                                    );
                                }}
                                type="button"
