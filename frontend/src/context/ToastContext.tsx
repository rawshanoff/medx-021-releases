                ...
                {toasts.map(toast => (
                    ...
                    >
                        <div className="flex min-w-0 items-start gap-2">
                            {toast.type === 'success' && <CheckCircle size={16} className="mt-0.5 text-[hsl(var(--success))]" />}
                            {toast.type === 'error' && <AlertCircle size={16} className="mt-0.5 text-destructive" />}
                            {toast.type === 'warning' && <AlertCircle size={16} className="mt-0.5 text-[hsl(var(--warning))]" />}
