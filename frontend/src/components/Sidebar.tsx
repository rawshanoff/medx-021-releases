  ...
  return (
    ...
    >
      ...
      <div className="border-t border-border p-2">
        ...
        <div
          className={cn(
            'mb-2 flex items-center gap-2 rounded-md border border-border bg-background p-2',
            collapsed ? 'justify-center' : '',
          )}
          title={profileName}
        >
        ...
        <div
          className={cn(
            'mb-2 flex items-center justify-between gap-1 rounded-md border border-border bg-background p-1',
            collapsed ? 'flex-col' : '',
          )}
        >
          <LanguageSwitcher />
        ...
        <Button
          ...
          className={cn(
            'w-full justify-start text-destructive hover:bg-secondary',
            collapsed ? 'justify-center' : '',
          )}
        >
          <LogOut size={16} />
