      ...
      en: {
        translation: {
          ...
          finance: {
            ...
            open_shift_prompt:
              'The shift is currently closed. You must open a shift to process payments.',
          },
          doctors: {
      ...
      ru: {
        translation: {
          ...
          registration: {
            ...
            sections: {
              ...
              medical: {
                ...
                desc: 'Добавьте важные медицинские сведения.',
              },
            },
            fields: {
          ...
          finance: {
            ...
            open_shift_prompt:
              'Смена сейчас закрыта. Вы должны открыть смену для проведения оплаты.',
          },
          doctors: {
      ...
      uz: {
        translation: {
          ...
          finance: {
            ...
            open_shift_prompt:
              "Smena hozirda yopiq. To'lovlarni amalga oshirish uchun smenani ochishingiz kerak.",
          },
          doctors: {
